...
var Images = {
  logoImg: require('../components/assets/images/logo.png'),
  homePhoneOne: require('../components/assets/images/MainPage/phoneFirstHome.png'),
  imageShadowQuote: require('../components/assets/images/MainPage/imageShadowHome.png'),
  reactPhonItem: require('../components/assets/images/reactItemPhon.png'),
  promotionBoard: require('../components/assets/images/MainPage/promotionBoard.png'),
