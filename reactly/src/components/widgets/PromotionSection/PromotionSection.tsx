            ...
            <section className='promotionSection__content'>
                ...
                <section className='promotionSection__contentNav'>
                    <nav className='promotionSection_nav'>
                        <Link to="OilSearch"><ButtonDefault width='150%' height='100%'>Подбор масла</ButtonDefault></Link>
                        <Link to="Products"><ButtonDefault classNameSecond='True' width='150%' height='100%'>Купить масло</ButtonDefault></Link>
                    </nav>
